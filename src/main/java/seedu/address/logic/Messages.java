...
public class Messages {
    ...
    //public static final String MESSAGE_EMPTY_BOOK_HINT = "AddressBook is empty. Try add-snr or add-cgr to get started!";
    public static final String MESSAGE_NO_SENIORS_PROMPT = "No seniors in AddressBook. Use add-snr to add a senior!";
    public static final String MESSAGE_NO_CAREGIVERS_PROMPT = "No caregivers in AddressBook. Use add-cgr command to add a caregiver!";
