...
import static seedu.address.logic.Messages.MESSAGE_INVALID_CAREGIVER_INDEX;
import static seedu.address.logic.Messages.MESSAGE_INVALID_SENIOR_INDEX;
...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteSeniorCommand = "delete s/9";
        assertCommandException(deleteSeniorCommand, MESSAGE_INVALID_SENIOR_INDEX);
        String deleteCaregiverCommand = "delete c/9";
        assertCommandException(deleteCaregiverCommand, MESSAGE_INVALID_CAREGIVER_INDEX);
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addSeniorCommand = AddSeniorCommand.COMMAND_WORD
                + NAME_DESC_AMY
                + PHONE_DESC_AMY
                + ADDRESS_DESC_AMY
                + TAG_DESC_AMY
                + NOTE_DESC_AMY;
        Senior expectedPerson = new SeniorBuilder(AMY).build();
